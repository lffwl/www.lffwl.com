...
type ArticleIndexReq struct {
	g.Meta `path:"/content" tags:"Article" method:"get" summary:"文章列表"`
...
type ArticleStoreReq struct {
	g.Meta  `path:"/content" tags:"Article" method:"post" summary:"新增文章"`
...
type ArticleUpdateReq struct {
	g.Meta  `path:"/content/{id}" tags:"Article" method:"post" summary:"更新文章"`
...
type ArticleDeleteReq struct {
	g.Meta `path:"/content/{id}/delete" tags:"Article" method:"post" summary:"删除文章"`
	Id     uint `in:"path" v:"min:1#Id必须要大于0" dc:"id"`
}
type ArticleDeleteRes struct{}

type ArticleShowReq struct {
	g.Meta `path:"/content/{id}" tags:"Article" method:"get" summary:"文章详情"`
	Id     uint `in:"path" v:"min:1#Id必须要大于0" dc:"id"`
}
